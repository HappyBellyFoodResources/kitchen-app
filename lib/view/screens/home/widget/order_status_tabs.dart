...
import 'package:happy_belly_kitchen/view/screens/home/widget/order_status_tabs_item.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class OrderStatusTabBar extends StatelessWidget {
  final TextEditingController searchTextController;
  const OrderStatusTabBar({Key? key, required this.searchTextController})
      : super(key: key);
              ...
              return InkWell(
                ...
                onTap: () {
                  ...
                  Get.find<OrderController>().updateOrderStatusTabs(
                      OrderStatusTabs.values.elementAt(index));
                  if (OrderStatusTabs.values.elementAt(index).name == 'all') {
                    ...
                    Get.find<OrderController>().filterOrder(
                        OrderStatusTabs.values.elementAt(index).name, 1);
                  }
                },
              );
            });
