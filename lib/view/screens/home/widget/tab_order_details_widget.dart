...
class _TabOrderDetailsWidgetState extends State<TabOrderDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return widget.orderId == 0
        ? const NoDataScreen(
            isDetails: true,
          )
        : GetBuilder<OrderController>(builder: (orderDetailsController) {
                            ...
                            : Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        '${'order'.tr}# ${orderDetailsController.orderDetails.order.id.toString()}',
                                        style: robotoMedium.copyWith(
                                            fontSize: Dimensions.fontSizeLarge),
                                      ),
                                      Row(
