...
import 'package:happy_belly_kitchen/view/base/custom_search_field.dart';
import 'package:happy_belly_kitchen/view/base/logout_dialog.dart';
import 'package:happy_belly_kitchen/view/screens/home/tab_home_screen.dart';
import 'package:happy_belly_kitchen/view/screens/home/widget/order_list_view.dart';
import 'package:happy_belly_kitchen/view/screens/home/widget/setting_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(
      length: 4,
      initialIndex:
          !widget.fromFilter ? 0 : Get.find<OrderController>().currentIndex,
      vsync: this,
    );
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton:
            ResponsiveHelper.isMobile(context) ? const SettingWidget() : null,
        body: ResponsiveHelper.isTab(context)
            ? TabHomeScreen(
                searchEditController: searchController,
                tabController: _tabController,
              )
            : mobileBody(context),
      ),
