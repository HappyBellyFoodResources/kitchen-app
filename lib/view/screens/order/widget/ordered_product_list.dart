...
import 'package:happy_belly_kitchen/view/base/custom_divider.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class OrderedProductList extends StatelessWidget {
  final OrderController orderController;
  const OrderedProductList({Key? key, required this.orderController})
      : super(key: key);
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          List<AddOns> addonsData =
              orderController.orderDetails.details[index].productDetails == null
                  ? []
                  : orderController.orderDetails.details[index].productDetails!
                              .addOns ==
                          null
                      ? []
                      : orderController
                          .orderDetails.details[index].productDetails!.addOns!;
          ...
          for (var addOn in addonsData) {
            if (orderController.orderDetails.details[index].addOnIds!
                .contains(addOn.id)) {
              addOns.add(addOn);
            }
          }
